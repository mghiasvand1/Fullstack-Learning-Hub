...
<template>
    <div class="p-6 flex items-center justify-between bg-gray-100 rounded-xl">
        ...
        <div class="space-x-4">
            <NuxtLink v-bind:to="'/browse/' + job.id" class="py-4 px-6 bg-teal-700 text-white rounded-xl">Details
            </NuxtLink>
            <NuxtLink v-bind:to="'/editjob/' + job.id" class="py-4 px-6 bg-cyan-700 text-white rounded-xl" v-if="my">
                Edit</NuxtLink>
