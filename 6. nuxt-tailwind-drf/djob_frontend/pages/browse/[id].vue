...
<template>
    <div class="py-10 px-6 grid md:grid-cols-4 gap-3">
        <div class="md:col-span-3">
            <h1 class="mb-6 text-xl">{{ job.title }}</h1>
            <p>
                {{ job.description }}
            </p>
            <a :href="'mailto:' + job.company_email"
                class="inline-block mt-6 py-4 px-6 bg-teal-700 rounded-lg text-white">Apply</a>
        </div>
        <div class="md:col-span-1 p-6 bg-teal-600 text-white rounded-xl">
